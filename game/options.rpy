...
以十三班各男女为原型写出脚本，配音由于麦克风损坏只能使用微软TTS（可以关声音...）
由于本人不会画画，只能使用SD AI模型生成背景和人物，但由于AI的局限性，大部分场景无法实现，所以只能先使用NVL（多文本模式）展现，可能跟大家想象的普通黄油有所区别
感谢各位大佬来玩本人制作的游戏 :)
""")
...
define build.name = "UnderTheWutongTree"
...
define config.save_directory = "UnderTheWutongTree-1687961488"
